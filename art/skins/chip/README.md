# chip — a recolour, baked

Blue-and-white porcelain: a china pattern of willow and blossom on a pale glaze.
From `assets/source/skins/CHIP/CHIP.glb`, the BOG sculpt retextured by Tripo on
...
Baked by `python tools/bake_skin.py CHIP` (which `extract_skins.py` calls on its
