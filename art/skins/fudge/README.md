# fudge — a recolour, baked

Chocolate fudge: brown with caramel swirls and flecks of nut.
From `assets/source/skins/FUDGE/FUDGE.glb`, the BOG sculpt retextured by Tripo on
...
Baked by `python tools/bake_skin.py FUDGE` (which `extract_skins.py` calls on its
