# koi — a recolour, baked

A koi carp: white with orange and black patches.
From `assets/source/skins/KOI/KOI.glb`, the BOG sculpt retextured by Tripo on
...
Baked by `python tools/bake_skin.py KOI` (which `extract_skins.py` calls on its
