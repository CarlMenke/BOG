# volt — a recolour, baked

Circuitry: deep violet with neon magenta and cyan traces glowing along the limbs.
From `assets/source/skins/VOLT/VOLT.glb`, the BOG sculpt retextured by Tripo on
...
Baked by `python tools/bake_skin.py VOLT` (which `extract_skins.py` calls on its
