...
| `SpearThrowLonger.fbx` | 171 | 2.833 s | 2.842 m | 2.842 m | A javelin throw **with a run-up**: the hips cover 2.84 m over the clip at 1.003 m/s. That travel is real motion, not root drift, and the window step 4 cuts has to start after the approach or the Bog will slide into its own throw. |
...
game at all. The Bog throws standing upright from wherever it is.
