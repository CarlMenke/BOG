...
# one skinned mesh that binds to the Bog's own skeleton.
#
...
# `tools/find_blender.sh`, shared with `tools/build_bog.sh`, for the reason
...
#
# The input is `art/generated/bog.glb`, so a rebuilt Bog means a rebuilt Elder:
#
#   bash tools/build_bog.sh
...
#
# Inputs:  $BLENDER (optional override), art/generated/bog.glb.
